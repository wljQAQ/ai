...
class ChatService(BaseService):
    ...
    def __init__(self,
        ...
        self.provider_configs = provider_configs or {
            "openai": {
                "api_key": "sk-test123456789",  # 应从环境变量或配置文件读取
    ...
    def _convert_to_unified_request(self,
                                    message: str,
                                    model: str = None,
                                    temperature: Optional[float] = None,
                                    max_tokens: Optional[int] = None,
                                    stream: bool = False) -> UnifiedChatRequest:
        """将聊天参数转换为统一请求格式
